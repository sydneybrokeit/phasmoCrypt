...
var fileNameInput = flag.String("input", "saveDataEdit.txt", "filename for input to decrypt")
var fileNameOutput = flag.String("output", "saveDataReEnc.txt", "filename for output after decrypting")
